...
export async function POST(
  ...
  try {
    ...
    const message = `Hi ${appointment.appointee}, your appointer (${appointment.appointer}) has signed your appointment letter. Please review and sign:${whatsAppLinkLine(signUrl)}`;
