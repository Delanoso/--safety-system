  ...
  const items = [
    {
      ...
      description: "Log a fire, evacuation or other emergency drill with findings and actions.",
      route: "/emergency-drills/add",
    },
    {
      title: "View All Drills",
      description: "Browse and search your emergency drill register.",
      route: "/emergency-drills/list",
    },
  ];
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-10 bg-gradient-to-r from-blue-200 to-purple-300">
      <div className="max-w-5xl mx-auto space-y-8 sm:space-y-10">
        ...
        <h1 className="text-2xl sm:text-4xl font-bold text-black">Emergency Drills</h1>
        <p className="text-black/70 text-sm sm:text-base">
          Plan, record and review emergency drills — fire, evacuation, spill response and more.
        </p>
