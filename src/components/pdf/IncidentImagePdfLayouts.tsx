...
/** One 2×2 photo grid for a single PDF appendix page */
export function IncidentPhotoPageGrid({
  images,
  pageIndex = 0,
}: {
...
/** One relevant-information page (up to 2 items with comments) */
export function IncidentRelevantInfoPage({
  images,
  pageIndex = 0,
}: {
  images: IncidentImageRecord[];
